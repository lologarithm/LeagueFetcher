	...
	var MatchHistoryView = React.createClass({displayName: 'MatchHistoryView',
		...
		render: function () {
			...
			if(this.state.championName !== '') {
				...
				return React.DOM.div( {className:"flexContainer", style:{'width':'400px', 'margin':'200px auto 0'}}, 
							React.DOM.input( {type:"text", className:"flex1", value:this.state.championInputName, onChange:this.onChange} ),
