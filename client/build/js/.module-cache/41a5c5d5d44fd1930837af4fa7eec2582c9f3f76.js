		...
		render: function () {
			return React.DOM.div( {className:"matchHistoryElement padding-m margin-bottom-m"} , 
						React.DOM.div(null, 
							...
							React.DOM.span( {style:{'display':'inline-block', 'float':'right'}}, this.props.data.Stats.ChampionsKilled,"/",this.props.data.Stats.NumDeaths,"/",this.props.data.Stats.Assists)
						),
